...
public class DOF_vacio_Test {
    ...
    public void test1()
    {
        ...
        String[] prueba = { "test/smrunner/medios/html/DOF_optional1.xhtml",
                            "test/smrunner/medios/html/DOF_vacio.xhtml"};
    ...
    {
        System.out.println("DOF's");
        String[] prueba = { "test/smrunner/medios/html/DOF_variable1.xhtml",
                            "test/smrunner/medios/html/DOF_variable2.xhtml",
                            "test/smrunner/medios/html/DOF_vacio.xhtml"};
        SMRunner rr = new SMRunner(prueba);
        Edible w = rr.process();
        System.out.println(w);
    ...
    {
        System.out.println("DOF's");
        String[] prueba = { "test/smrunner/medios/html/DOF_list1.xhtml",
                            "test/smrunner/medios/html/DOF_vacio.xhtml"};
        SMRunner rr = new SMRunner(prueba);
        Edible w = rr.process();
        System.out.println(w);
